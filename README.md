# Spring Boot + MySQL example - chanakya TECHNOLOGIES | Soni | 97397*****
# Sample commit - 04
...
$ docker run --name mydb -p 3306:3306 -e MYSQL_USER=chanakyatech -e MYSQL_PASSWORD=password -e MYSQL_ROOT_PASSWORD=password -e MYSQL_DATABASE=mychanakyadb -d mysql:8.1

# Check if mysql is working fine
$ docker exec -it mydb mysql -uroot -ppassword
  mysql> show databases;
  mysql> use mychanakyadb;
  mysql> show tables;
  mysql> select * from books;

# Deploy the application
$ nohup java -jar target/chanakyatech-springboot-mysql-97397*****.jar 2>&1 &
